...
{
  "id": "src-pnl12-c4-extra-barrel-parabola",
  "topic_id": "top-12-4-3",
  "type_id": "type-kntt-12-13-04",
  "question_type": "NUMERIC",
  "format_type": "TLN",
  "difficulty": "HARD",
  "language_level": 2,
  "question_vi": "Một thùng rượu có hai đáy tròn bán kính 30 cm, tiết diện giữa thùng bán kính 40 cm và chiều dài 1 m như hình. Mặt cắt qua trục là các cung parabol có đỉnh ở tiết diện giữa. Tính dung tích thùng (lít), làm tròn đến hàng đơn vị.",
  "question_en": "A barrel has circular ends of radius 30 cm, a middle cross-section of radius 40 cm, and length 1 m as shown. Its axial profile is parabolic. Find the capacity in liters, rounded to the nearest liter.",
  "solution_vi": "Chọn trục dọc theo thùng, đơn vị mét. Bán kính có dạng $y=-\\frac{2}{5}x^2+0.4$ trên $[-0.5,0.5]$. Do đó $V=\\pi\\int_{-0.5}^{0.5}y^2\\,dx=\\frac{203\\pi}{1500}\\text{ m}^3\\approx425$ lít.",
  "solution_en": "With the axis along the barrel, the radius is $y=-\\frac25x^2+0.4$ for $-0.5\\le x\\le0.5$. Thus $V=\\pi\\int_{-0.5}^{0.5}y^2\\,dx\\approx425$ L.",
  "correct_answer": "425",
  "assets": [{"kind":"image","src":"/question-assets/source/pnl-12-c4-extra/barrel-parabola.png","alt_vi":"Mặt cắt thùng rượu parabol với các kích thước đã cho.","alt_en":"Parabolic barrel profile with dimensions.","title_vi":"","title_en":"","source_name":"Phan Nhật Linh - Toán 12 KNTT Chương 4","source_sha256":"6188770ac7513f1e2f65382fef5ca4d2609e752373ba08eb93d21407484a7b7c"}],
  "math_skill": "Ứng dụng tích phân tính thể tích vật chứa thực tế",
  "english_skill": "Use integration to compute a real-world container volume",
  "status": "PUBLISHED",
  "created_by": "source-pnl-gv-original-media",
  "variant_tag": "pnl12-c4-real-barrel-parabola",
  "grading_safe": true,
  "source_name": "Phan Nhật Linh - Toán 12 KNTT Chương 4",
  "created_at": "2026-08-29T08:30:00.000Z"
},
{
  "id": "src-pnl12-c4-extra-oil-tank",
  "topic_id": "top-12-4-3",
  "type_id": "type-kntt-12-13-04",
  "question_type": "NUMERIC",
  "format_type": "TLN",
  "difficulty": "HARD",
  "language_level": 2,
  "question_vi": "Một bồn hình trụ đặt nằm ngang dài 5 m, bán kính đáy 1 m. Người ta rút dầu đến mức phần bị rút tương ứng với một đoạn cao 0,5 m của đường kính như hình. Tính thể tích dầu còn lại (m³), làm tròn đến hàng phần mười.",
  "question_en": "A horizontal cylindrical tank is 5 m long with radius 1 m. Oil is removed so that the empty circular segment has height 0.5 m as shown. Find the remaining oil volume in cubic meters, rounded to one decimal place.",
  "solution_vi": "Thể tích toàn bồn là $5\\pi$. Diện tích phân đoạn tròn bị rút được tính bằng diện tích quạt tròn trừ tam giác; nhân với chiều dài 5 m. Suy ra thể tích dầu còn lại xấp xỉ $12.6\\text{ m}^3$.",
  "solution_en": "The full volume is $5\\pi$. Compute the removed circular-segment area as sector minus triangle and multiply by 5 m. The remaining volume is about $12.6\\text{ m}^3$.",
  "correct_answer": "12.6",
  "assets": [{"kind":"image","src":"/question-assets/source/pnl-12-c4-extra/oil-tank.png","alt_vi":"Bồn hình trụ nằm ngang và phần dầu bị rút.","alt_en":"Horizontal cylindrical tank and removed oil segment.","title_vi":"","title_en":"","source_name":"Phan Nhật Linh - Toán 12 KNTT Chương 4","source_sha256":"61a467038ca20500537bbfc7dc91a402fe5e99186a5b87753a618eb5b2af4230"}],
  "math_skill": "Ứng dụng tích phân và diện tích phân đoạn tròn tính thể tích",
  "english_skill": "Compute tank volume from a circular segment",
  "status": "PUBLISHED",
  "created_by": "source-pnl-gv-original-media",
  "variant_tag": "pnl12-c4-real-horizontal-tank",
  "grading_safe": true,
  "source_name": "Phan Nhật Linh - Toán 12 KNTT Chương 4",
  "created_at": "2026-08-29T08:30:00.000Z"
},
{
  "id": "src-pnl12-c4-extra-sine-sheet",
  "topic_id": "top-12-4-3",
  "type_id": "type-kntt-12-13-04",
  "question_type": "NUMERIC",
  "format_type": "TLN",
  ...
  "english_skill": "Use a definite integral for a real-world solid of revolution",
  "status": "PUBLISHED",
  "created_by": "source-pnl-gv-original-media",
  "variant_tag": "pnl12-c4-real-sine-sheet",
  "grading_safe": true,
  "source_name": "Phan Nhật Linh - Toán 12 KNTT Chương 4",
  "created_at": "2026-08-29T08:30:00.000Z"
},
{
  "id": "src-pnl12-c4-extra-parabolic-cup",
  "topic_id": "top-12-4-3",
  "type_id": "type-kntt-12-13-04",
  "question_type": "NUMERIC",
  "format_type": "TLN",
  "difficulty": "MEDIUM",
  "language_level": 2,
  "question_vi": "Một chiếc ly có dạng khối tròn xoay như hình, đường kính miệng ly 4 cm, chiều cao 6 cm và thiết diện qua trục là một parabol. Tính thể tích của ly (cm³), làm tròn đến hàng phần mười.",
  "question_en": "A cup is a solid of revolution as shown. Its mouth diameter is 4 cm, height is 6 cm, and its axial cross-section is parabolic. Find its volume in cubic centimeters, rounded to one decimal place.",
  "solution_vi": "Đặt đỉnh parabol tại đáy ly, ta có $y^2=\\frac23x$ với $0\\le x\\le6$. Quay quanh trục $Ox$: $V=\\pi\\int_0^6y^2\\,dx=\\pi\\int_0^6\\frac23x\\,dx=12\\pi\\approx37.7\\text{ cm}^3$.",
  "solution_en": "Place the parabola vertex at the bottom: $y^2=\\frac23x$, $0\\le x\\le6$. Rotating about $Ox$ gives $V=\\pi\\int_0^6\\frac23x\\,dx=12\\pi\\approx37.7\\text{ cm}^3$.",
  "correct_answer": "37.7",
  "assets": [{"kind":"image","src":"/question-assets/source/pnl-12-c4-extra/parabolic-cup.png","alt_vi":"Chiếc ly có thiết diện parabol, đường kính 4 cm và cao 6 cm.","alt_en":"Parabolic cup with 4 cm mouth diameter and 6 cm height.","title_vi":"","title_en":"","source_name":"Phan Nhật Linh - Toán 12 KNTT Chương 4","source_sha256":"30d67657e133ded1765f3e307484611c7fc7ba789d69a6c55d1e9eb9e65f6a3a"}],
  "math_skill": "Ứng dụng tích phân tính thể tích khối tròn xoay",
  "english_skill": "Compute a parabolic solid-of-revolution volume",
  "status": "PUBLISHED",
  "created_by": "source-pnl-gv-original-media",
  "variant_tag": "pnl12-c4-real-parabolic-cup",
  "grading_safe": true,
  "source_name": "Phan Nhật Linh - Toán 12 KNTT Chương 4",
  "created_at": "2026-08-29T08:30:00.000Z"
}
...
,
{
  "id": "src-pnl12-c4-extra2-velocity-parabola",
  "topic_id": "top-12-4-2",
  "type_id": "type-kntt-12-12-05",
  "question_type": "MCQ",
  "format_type": "TN",
  "difficulty": "MEDIUM",
  "language_level": 2,
  "question_vi": "Một vật chuyển động trong 3 giờ với vận tốc $v$ (km/h) phụ thuộc thời gian $t$ (h); đồ thị vận tốc là một phần parabol có đỉnh $I(2;9)$ như hình và đi qua $A(0;6)$. Quãng đường vật đi được trong 3 giờ bằng",
  "question_en": "A particle moves for 3 hours. Its speed $v$ (km/h) versus time $t$ (h) is the parabolic arc shown, with vertex $I(2,9)$ and passing through $A(0,6)$. The distance traveled in 3 hours is",
  "options": [
    {"option_key":"A","content_vi":"$25.25$ km","content_en":"$25.25$ km","is_correct":false},
    {"option_key":"B","content_vi":"$24.25$ km","content_en":"$24.25$ km","is_correct":false},
    {"option_key":"C","content_vi":"$24.75$ km","content_en":"$24.75$ km","is_correct":true},
    {"option_key":"D","content_vi":"$26.75$ km","content_en":"$26.75$ km","is_correct":false}
  ],
  "solution_vi": "Từ đỉnh $I(2;9)$ và điểm $A(0;6)$ suy ra $v(t)=-\\frac34t^2+3t+6$. Do đó $S=\\int_0^3v(t)\\,dt=24.75$ km.",
  "solution_en": "The vertex and point $A$ give $v(t)=-\\frac34t^2+3t+6$. Hence $S=\\int_0^3v(t)\\,dt=24.75$ km.",
  "correct_answer": "C",
  "assets": [{"kind":"image","src":"/question-assets/source/pnl-12-c4-extra2/velocity-parabola.png","alt_vi":"Đồ thị vận tốc theo thời gian là một phần parabol.","alt_en":"Parabolic speed-time graph.","title_vi":"","title_en":"","source_name":"Phan Nhật Linh - Toán 12 KNTT Chương 4","source_sha256":"1b6f60270b7f288699535975ca309ed99b1c8e2a0def65893977f594a4d08835"}],
  "math_skill": "Tính quãng đường từ đồ thị vận tốc bằng tích phân",
  "english_skill": "Integrate a speed-time graph to find distance",
  "status": "PUBLISHED",
  "created_by": "source-pnl-gv-original-media",
  "variant_tag": "pnl12-c4-cumulative-velocity-parabola",
  "grading_safe": true,
  "source_name": "Phan Nhật Linh - Toán 12 KNTT Chương 4",
  "created_at": "2026-08-29T09:15:00.000Z"
},
{
  "id": "src-pnl12-c4-extra2-hooke-spring",
  "topic_id": "top-12-4-2",
  "type_id": "type-kntt-12-12-05",
  "question_type": "NUMERIC",
  "format_type": "TLN",
  "difficulty": "MEDIUM",
  "language_level": 2,
  "question_vi": "Một lực 40 N kéo lò xo có chiều dài tự nhiên 10 cm thành 15 cm. Theo định luật Hooke, lực đàn hồi có dạng $f(x)=kx$, với $x$ là độ dãn tính bằng mét. Tính công (J) cần để kéo lò xo từ chiều dài 15 cm đến 20 cm.",
  "question_en": "A 40 N force stretches a spring from its natural length of 10 cm to 15 cm. By Hooke's law, $f(x)=kx$, where $x$ is the extension in meters. Find the work (J) required to stretch it from 15 cm to 20 cm.",
  "solution_vi": "$40=k(0.05)$ nên $k=800$. Công cần tìm là $W=\\int_{0.05}^{0.10}800x\\,dx=3$ J.",
  "solution_en": "$40=k(0.05)$ gives $k=800$. Thus $W=\\int_{0.05}^{0.10}800x\\,dx=3$ J.",
  "correct_answer": "3",
  "assets": [{"kind":"image","src":"/question-assets/source/pnl-12-c4-extra2/hooke-spring.png","alt_vi":"Mô hình kéo dãn lò xo theo định luật Hooke.","alt_en":"Spring stretching model under Hooke's law.","title_vi":"","title_en":"","source_name":"Phan Nhật Linh - Toán 12 KNTT Chương 4","source_sha256":"927f3d096afa3e3ecf86188dbfc619ea06771d3f37d28f486bd046d75414406d"}],
  "math_skill": "Ứng dụng tích phân tính công của lực biến thiên",
  "english_skill": "Use a definite integral to compute work",
  "status": "PUBLISHED",
  "created_by": "source-pnl-gv-original-media",
  "variant_tag": "pnl12-c4-cumulative-hooke-work",
  "grading_safe": true,
  "source_name": "Phan Nhật Linh - Toán 12 KNTT Chương 4",
  "created_at": "2026-08-29T09:15:00.000Z"
},
{
  "id": "src-pnl12-c4-extra2-heart-output",
  "topic_id": "top-12-4-2",
  "type_id": "type-kntt-12-12-05",
  "question_type": "NUMERIC",
  "format_type": "TLN",
  ...
  "english_skill": "Use integration in a cardiac-output model",
  "status": "PUBLISHED",
  "created_by": "source-pnl-gv-original-media",
  "variant_tag": "pnl12-c4-cumulative-cardiac-output",
  "grading_safe": true,
  "source_name": "Phan Nhật Linh - Toán 12 KNTT Chương 4",
  "created_at": "2026-08-29T09:15:00.000Z"
}
...
,
{
  "id": "src-pnl12-c4-extra3-petal-tile",
  "topic_id": "top-12-4-3",
  "type_id": "type-kntt-12-13-04",
  "question_type": "MCQ",
  "format_type": "TN",
  "difficulty": "MEDIUM",
  "language_level": 2,
  "question_vi": "Một viên gạch hoa hình vuông cạnh 60 cm. Bốn đường parabol có chung đỉnh tại tâm viên gạch tạo thành bốn cánh hoa tô đậm như hình. Diện tích toàn bộ phần bốn cánh hoa bằng bao nhiêu?",
  "question_en": "A square decorative tile has side length 60 cm. Four parabolas sharing the tile center as a vertex form the four shaded petals shown. What is the total shaded-petal area?",
  "options": [
    {"option_key":"A","content_vi":"$1200\\text{ cm}^2$","content_en":"$1200\\text{ cm}^2$","is_correct":true},
    {"option_key":"B","content_vi":"$600\\text{ cm}^2$","content_en":"$600\\text{ cm}^2$","is_correct":false},
    {"option_key":"C","content_vi":"$900\\text{ cm}^2$","content_en":"$900\\text{ cm}^2$","is_correct":false},
  ...
  "english_skill": "Use definite integrals to compute a real-world planar area",
  "status": "PUBLISHED",
  "created_by": "source-pnl-gv-original-media",
  "variant_tag": "pnl12-c4-real-parabolic-petal-tile",
  "grading_safe": true,
  "source_name": "Phan Nhật Linh - Toán 12 KNTT Chương 4 (bản GV)",
  "created_at": "2026-08-29T09:30:00.000Z"
},
{
  "id": "src-pnl12-c4-extra3-concrete-path",
  "topic_id": "top-12-4-3",
  "type_id": "type-kntt-12-13-04",
  "question_type": "MCQ",
  "format_type": "TN",
  "difficulty": "MEDIUM",
  "language_level": 2,
  "question_vi": "Cô Hạnh đổ bê tông phần đường đi tô xám trong hình. Đường cong $DC$ là ảnh của đường cong $AB$ khi tịnh tiến thẳng đứng lên 2 m; chiều dài theo phương ngang là 10 m. Lớp bê tông dày 15 cm, giá 1 m³ bê tông là 1.080.000 đồng. Chi phí cần dùng bằng",
  "question_en": "The shaded garden path is bounded by curves $AB$ and $DC$, where $DC$ is obtained by translating $AB$ vertically upward by 2 m over a horizontal length of 10 m. The concrete layer is 15 cm thick and costs 1,080,000 VND per cubic meter. The required cost is",
  "options": [
    {"option_key":"A","content_vi":"$3\\,240\\,000$ đồng","content_en":"$3\\,240\\,000$ VND","is_correct":true},
    {"option_key":"B","content_vi":"$2\\,160\\,000$ đồng","content_en":"$2\\,160\\,000$ VND","is_correct":false},
    {"option_key":"C","content_vi":"$4\\,320\\,000$ đồng","content_en":"$4\\,320\\,000$ VND","is_correct":false},
    {"option_key":"D","content_vi":"$32\\,400\\,000$ đồng","content_en":"$32\\,400\\,000$ VND","is_correct":false}
  ],
  "solution_vi": "Nếu $AB$ có phương trình $y=f(x)$ thì $DC$ có phương trình $y=f(x)+2$. Diện tích lối đi là $S=\\int_0^{10}[(f(x)+2)-f(x)]dx=20\\text{ m}^2$. Thể tích bê tông là $20\\cdot0.15=3\\text{ m}^3$, nên chi phí là $3\\cdot1\\,080\\,000=3\\,240\\,000$ đồng.",
  "solution_en": "If $AB$ is $y=f(x)$, then $DC$ is $y=f(x)+2$. The path area is $\\int_0^{10}2\\,dx=20\\text{ m}^2$. With thickness $0.15$ m, the volume is $3\\text{ m}^3$, costing $3,240,000$ VND.",
  "correct_answer": "A",
  "assets": [{"kind":"image","src":"/question-assets/source/pnl-12-c4-extra3/concrete-path.png","alt_vi":"Lối đi trong vườn giới hạn bởi hai đường cong cách nhau 2 m.","alt_en":"Garden path between two curves vertically separated by 2 m.","title_vi":"","title_en":"","source_name":"Phan Nhật Linh - Toán 12 KNTT Chương 4 (bản GV)","source_sha256":"87f2752c600572a9d7142ff33af6c603b3b3d50ee1919922a9c1bce98e7ba5e7"}],
  "math_skill": "Ứng dụng tích phân tính diện tích, thể tích và chi phí thực tế",
  "english_skill": "Use integration for area, volume and real-world cost",
  "status": "PUBLISHED",
  "created_by": "source-pnl-gv-original-media",
  "variant_tag": "pnl12-c4-real-concrete-garden-path",
  "grading_safe": true,
  "source_name": "Phan Nhật Linh - Toán 12 KNTT Chương 4 (bản GV)",
  "created_at": "2026-08-29T09:30:00.000Z"
},
{
  "id": "src-pnl12-c4-extra3-tea-cup",
  "topic_id": "top-12-4-3",
  "type_id": "type-kntt-12-13-04",
  "question_type": "MCQ",
  "format_type": "TN",
  "difficulty": "MEDIUM",
  "language_level": 2,
  "question_vi": "Chiếc chén trong hình được mô hình hóa bằng cách quay miền giới hạn bởi $f(x)=0.14x^3-0.87x^2+1.92x+0.85$, trục hoành và hai đường thẳng $x=0$, $x=3$ quanh trục $Ox$ (đơn vị cm). Thể tích chiếc chén, làm tròn đến cm³, bằng",
  "question_en": "The cup shown is modeled by rotating the region bounded by $f(x)=0.14x^3-0.87x^2+1.92x+0.85$, the $x$-axis, and $x=0$, $x=3$ about the $x$-axis, with centimeters as units. Its volume, rounded to the nearest cubic centimeter, is",
  "options": [
    {"option_key":"A","content_vi":"$42\\text{ cm}^3$","content_en":"$42\\text{ cm}^3$","is_correct":true},
    {"option_key":"B","content_vi":"$38\\text{ cm}^3$","content_en":"$38\\text{ cm}^3$","is_correct":false},
    {"option_key":"C","content_vi":"$84\\text{ cm}^3$","content_en":"$84\\text{ cm}^3$","is_correct":false},
    {"option_key":"D","content_vi":"$126\\text{ cm}^3$","content_en":"$126\\text{ cm}^3$","is_correct":false}
  ],
  "solution_vi": "Theo phương pháp đĩa, $V=\\pi\\int_0^3[f(x)]^2dx\\approx41.87\\text{ cm}^3$. Làm tròn đến hàng đơn vị được $42\\text{ cm}^3$.",
  "solution_en": "By the disk method, $V=\\pi\\int_0^3[f(x)]^2dx\\approx41.87\\text{ cm}^3$, which rounds to $42\\text{ cm}^3$.",
  "correct_answer": "A",
  "assets": [{"kind":"image","src":"/question-assets/source/pnl-12-c4-extra3/tea-cup.png","alt_vi":"Chiếc chén và mô hình khối tròn xoay quanh trục Ox.","alt_en":"Tea cup and its solid-of-revolution model about the x-axis.","title_vi":"","title_en":"","source_name":"Phan Nhật Linh - Toán 12 KNTT Chương 4 (bản GV)","source_sha256":"7b98b251fb893264ec57a9d82a95d024a7930f7912ae1ba516e854d67057693e"}],
  "math_skill": "Ứng dụng tích phân tính thể tích khối tròn xoay thực tế",
  "english_skill": "Use the disk method for a real-world solid of revolution",
  "status": "PUBLISHED",
  "created_by": "source-pnl-gv-original-media",
  "variant_tag": "pnl12-c4-real-tea-cup-polynomial",
  "grading_safe": true,
  "source_name": "Phan Nhật Linh - Toán 12 KNTT Chương 4 (bản GV)",
  "created_at": "2026-08-29T09:30:00.000Z"
}
