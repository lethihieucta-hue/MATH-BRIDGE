...
export const MobileNav: React.FC = () => {
  ...
  if (currentRole === 'TEACHER') {
    return (
      <div className="lg:hidden fixed bottom-0 left-0 right-0 z-40 bg-[#111322]/95 backdrop-blur-xl border-t border-slate-800 px-6 py-2.5 flex justify-around items-center text-slate-400 shadow-2xl">
        <button
